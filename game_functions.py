...
def create_fleet(ai_settings,screen,ship,aliens):
    ...
    #Create an alien and find the numbere of aliens in a row
...
def check_play_button(ai_settings,screen,stats,sb,play_button,ship,aliens,bullets,mouse_x,mouse_y):
    ...
    """Start a new game when the playing clicks play"""
    ...
    if button_clicked and not stats.game_active:
        ...
        sb.prep_level()
        sb.prep_ships()
        #Empty the list of aliens and bullets_allowed
        aliens.empty()
        bullets.empty()
...
def check_high_score(stats,sb):
    """Check to see if there is a neew high score"""
